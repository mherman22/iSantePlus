package org.openmrs.module.isanteplus.page;
...
/**
 *
 * Overrides the mapping to the login page for the reference application to a a
 * customized page for UgandaEMR
 *
 */
@Component
public class IsanteplusLoginPageRequestMapper implements PageRequestMapper {

	protected final Log log = LogFactory.getLog(getClass());

	public IsanteplusLoginPageRequestMapper() {
	...
	public boolean mapRequest(PageRequest request) {
		if (request.getProviderName().equals("referenceapplication")) {
			if (request.getPageName().equals("login")) {
				...
				request.setPageNameOverride("isanteplusLogin");
