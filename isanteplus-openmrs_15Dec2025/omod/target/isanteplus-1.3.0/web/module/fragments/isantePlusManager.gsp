...
<input type="checkbox" class="managerOption" id="${manager.viralLoadGraphExtensionId}" ${manager.viralLoadGraphExtensionChecked}> ${ ui.message('isanteplus.manageIsantePlusPatientDashboard.enableViralLoadGraph') }<br />
