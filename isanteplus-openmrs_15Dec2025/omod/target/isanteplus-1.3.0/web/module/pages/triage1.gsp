    ...
    <main class="tabs">
        ...
        <form id="form" method="POST" class="panels">
            ...
            <div id="panel-4"
                    ...
                    <div class="tab4-infos1">
                        <div class="check-group">
                            <div class="div-check-2">
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox"
                                           id="alerte">
                            ...
                            <div class="div-check-2">
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="nreagitp">
                ...
                <fieldset>
                    ...
                    <div class="tab4-infos1">
                        <div class="check-group">
                            <div class="div-check-2">
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="normale">
                                    <label for="normale">Normale</label>
                                </div>
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="respiratoire">
                                    <label for="respiratoire">Détresse Respiratoire</label>
                                </div>
                            </div>
                            <div class="div-check-2">
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="stridor">
                                    <label for="stridor">Stridor</label>
                                </div>
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="apnee">
                        ...
                        <div class="check-group">
                            <div class="div-check-2">
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="grognement">
                                    <label for="grognement">Grognement</label>
                                </div>
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="sifflement">
                                    <label for="sifflement">Sifflement</label>
                                </div>
                            </div>
                            <div class="div-check-2" style="height: 0px">
                                <div class="div-check">
                                </div>
                                <div class="div-check">
                                </div>
                ...
                <fieldset>
                    <legend><b>C (Circulation) - Peau / Muqueuse / Mains et Plantes des pieds</b></legend>
                    <div class="tab4-infos1">
                        <div class="check-group">
                            <div class="div-check-2">
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="pale">
                                    <label for="pale">Pâle</label>
                                </div>
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="cyanosee">
                                    <label for="cyanosee">Cyanosée</label>
                                </div>
                            </div>
                            <div class="div-check-2">
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="marbrure">
                                    <label for="marbrure">Marbrure</label>
                                </div>
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="seche">
                        ...
                        <div class="check-group">
                            <div class="div-check-2">
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="humide">
                                    <label for="grognement">Humide</label>
                                </div>
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="chaude">
                                    <label for="sifflement">Chaude</label>
                                </div>
                            </div>
                            <div class="div-check-2">
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="froide">
                                    <label for="froide ">Froide</label>
                                </div>
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="petechie">
                        ...
                        <div class="check-group">
                            <div class="div-check-2">
                                <div class="div-check">
                                    <input type="checkbox" name="evaluation" value="120749" class="checkbox" id="purpura">
                                    <label for="purpura">Purpura</label>
                                </div>
                                <div class="div-check">
                                    <div class="form-span">
                                        <label for="trc">TRC</label>
                                        <select class="form-select" name="trc" id="trc">
                                            <option value="">-- Sélectionner --</option>
            ...
            <div id="panel-5"
                ...
                <div class="button-group">
                    ...
                    <button id="btn-submit" type="submit" class="btn-next" style="${(patientId != null || visitId != null) ? 'display: none;' : ''}">
                        Enregistrer
                    </button>
                </div>
            </div>
