<%
    ui.decorateWith("appui", "standardEmrPage", [ title: ui.message("isanteplus.viralLoadHistory") ])
%>
...
<script type="text/javascript">
	var breadcrumbs = [
        ...
        { label: "${ ui.message('isanteplus.viralLoadHistory') }"}
    ];
</script>
...
<div class="info-section">
    <div class="info-header">
        <h3>${ ui.message("isanteplus.viralLoadHistory") }</h3>
    </div>
    <table>
