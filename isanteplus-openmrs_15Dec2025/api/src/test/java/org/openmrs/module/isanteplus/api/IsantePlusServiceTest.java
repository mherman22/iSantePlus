 ...
 */
public class IsantePlusServiceTest extends BaseModuleContextSensitiveTest {

	@Test
	public void shouldSetupContext() {
		assertNotNull(Context.getService(IsantePlusService.class));
	}
	...
	public void test_gettingObsAnswerUnitsAndRangeForeaxampleForLabHistory() {
		IsantePlusObs o = new IsantePlusObs(Context.getService(IsantePlusService.class)
