...
public class IsantePlusMetadataBundle extends AbstractMetadataBundle {
	...
	public void install() {
		...
		properties.put(ConfigurableGlobalProperties.REGISTRATIONCORE_LOCAL_MPI_IDENTIFIERTYPEMAP_iSante_ID, IsantePlusConstants.PATIENT_IDENTIFIER_TYPE_UUID_ISANTE_ID + ":" + ConfigurableGlobalProperties.REGISTRATIONCORE_MPI_iSante_ID_UNIVERSAL_IDENTIFIER + ":" + ConfigurableGlobalProperties.REGISTRATIONCORE_MPI_iSante_ID_UNIVERSAL_IDENTIFIER_TYPE);
		...
		properties.put(ConfigurableGlobalProperties.REGISTRATIONCORE_MPI_PDQ_IDENTIFIERTYPEUUIDLIST, IsantePlusConstants.PATIENT_IDENTIFIER_TYPE_UUID_ISANTEPLUS_ID + "," + IsantePlusConstants.HaitiCore_ECID_UUID + "," + IsantePlusConstants.HaitiCore_BIOMETRIC_NATIONAL_UUID + "," + IsantePlusConstants.HaitiCore_BIOMETRIC_UUID + "," + IsantePlusConstants.PATIENT_IDENTIFIER_TYPE_UUID_CODE_NATIONAL + "," + IsantePlusConstants.PATIENT_IDENTIFIER_TYPE_UUID_CODE_ST);
