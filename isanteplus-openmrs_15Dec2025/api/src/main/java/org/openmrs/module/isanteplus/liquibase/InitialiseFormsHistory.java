package org.openmrs.module.isanteplus.liquibase;

import java.sql.SQLException;

import org.openmrs.module.isanteplus.api.impl.IsantePlusServiceImpl;
...
public class InitialiseFormsHistory implements CustomTaskChange {
	...
	public void execute(Database database) throws CustomChangeException {
		...
		// yet ready
		try {
			new IsantePlusServiceImpl().runInitialHistoryCreatorAgainstDB(connection);
