...
public class FindPatientPageController {
	...
	public void get(PageModel model, @RequestParam("app") AppDescriptor app, UiSessionContext sessionContext,
        ...
        CoreAppsService coreAppsService = Context.getService(CoreAppsService.class);

        List<IsantePlusRelationship> isantePlusRelationshipList = (List<IsantePlusRelationship>) coreAppsService.getAllRelationships("fr");
