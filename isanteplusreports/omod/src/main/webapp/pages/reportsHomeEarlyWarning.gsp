...
<script type="text/javascript">
    ...
    var breadcrumbs = [
        ...
        { label: "${ ui.message("isanteplusreports.reportsapp.alertprecoce") }", link: '${ ui.thisUrl() }' }
    ];
</script>
...
<div class="reportBox">
    <% if (alertPrecoce) { %>
        <p> <i class="icon-exclamation-sign"></i> ${ ui.message("isanteplusreports.reportsapp.alertprecoce") }</p>
