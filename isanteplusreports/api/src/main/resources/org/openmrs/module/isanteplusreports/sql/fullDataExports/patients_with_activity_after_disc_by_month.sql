/*Patients (VIH) avec activité après discontinuation pour le mois*/
...
from isanteplus.patient p,
 ...
 WHERE e.encounter_type=et.encounter_type_id AND et.uuid = '9d0113c6-f23a-4461-8428-7e9a7344f2ba' AND e.voided <> 1 
 AND DATE(e.encounter_datetime) < :endDate GROUP BY 1) B
