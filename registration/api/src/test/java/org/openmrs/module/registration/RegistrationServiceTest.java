...
import org.openmrs.module.registration.Item;
...
/**
 * This is a unit test, which verifies logic in RegistrationService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class RegistrationServiceTest {
	
	@InjectMocks
	RegistrationServiceImpl basicModuleService;
