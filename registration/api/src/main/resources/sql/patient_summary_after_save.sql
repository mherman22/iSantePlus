...
insert into isanteplus.patient(patient_id, given_name, family_name, gender, birthdate, creator, date_created, last_inserted_date,last_updated_date, voided)
...
-- ST CODE
update isanteplus.patient p,openmrs.patient_identifier pi, openmrs.patient_identifier_type pit
...
update isanteplus.patient p, openmrs.person_address padd
set p.last_address=
