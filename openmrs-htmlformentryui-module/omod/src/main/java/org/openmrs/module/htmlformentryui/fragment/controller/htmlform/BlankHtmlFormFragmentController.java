 ...
 *
 */
public class BlankHtmlFormFragmentController extends BaseHtmlFormFragmentController {
    ...
    public void controller(FragmentConfiguration config,
        ...
        config.require("htmlForm | htmlFormId | formId | formUuid | definitionUiResource | encounter");
        ...
        FormEntrySession fes = new FormEntrySession(hf, FormEntryContext.Mode.ENTER, null, httpSession,
