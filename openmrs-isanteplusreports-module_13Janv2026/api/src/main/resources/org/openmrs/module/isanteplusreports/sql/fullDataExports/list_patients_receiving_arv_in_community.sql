...
TIMESTAMPDIFF(YEAR, pat.birthdate,DATE(now())) as Age, DATE(pdisp.visit_date) as 'Dernière date', pat.last_address as Adresse, pat.telephone as Téléphone,
...
AND pdisp.dispensation_location = 1755
