...
import static org.openmrs.module.isanteplusreports.util.IsantePlusReportsConstants.PSYCHOSOCIAL_RESOURCE_PATH;

public class PsychosocialReportsConstants {

    public static final String PSYCHOSOCIAL_REPORTS_RESOURCE_PATH = PSYCHOSOCIAL_RESOURCE_PATH;

    public static final String PSYCHOSOCIAL_REPORTS_PATIENT_LIST_SQL = "patient_summary_list.sql";
