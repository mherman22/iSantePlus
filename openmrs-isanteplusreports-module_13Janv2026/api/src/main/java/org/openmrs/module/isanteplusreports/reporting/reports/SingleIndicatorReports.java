...
public class SingleIndicatorReports {
	
	private static final String SINGLE_INDICATOR_REPORTS_UUID = "c47a8aae-410f-11ea-b77f-2e728ce88125";
	...
	public static void registerReport() {
		...
		IsantePlusReportsUtil.registerIndicatorReportsWithStartAndEndDateParams(
		    "isanteplusreports.single_indicator_reports",
		    MessageUtil.translate("isanteplusreports.single_indicator_reports"), SINGLE_INDICATOR_REPORTS_UUID, dsd);
	...
	private static CohortIndicatorDataSetDefinition reportDataSetDefinition() {
		...
		dsd.setName("isanteplusreports.single_indicator_reports");
		dsd.setDescription(MessageUtil.translate("isanteplusreports.single_indicator_reports"));
