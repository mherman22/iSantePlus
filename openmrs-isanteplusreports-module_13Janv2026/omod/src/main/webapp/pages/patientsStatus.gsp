        ...
        <% for (int i=0; i<reportManager.parameters.size(); i++) {
            ...
            <table>
			    ...
			    <tr>
        			...
        			<td> ${ ui.includeFragment("uicommons", "field/checkbox", [ "id": "tranferedOnArt", "label": "", "formFieldName": "tranferedOnArt", "checked": "checked"  ]) } ${ ui.message("isanteplusreports.parameters.hiv_status.transfered") } </td>
        		</tr>
        		<tr>
					<td> ${ ui.includeFragment("uicommons", "field/checkbox", [ "id": "unknown", "label": "", "formFieldName": "unknown",  "checked": "checked" ]) } ${ ui.message("isanteplusreports.parameters.hiv_status.unknown") } </td>
