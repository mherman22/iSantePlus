...
<div>
	...
	<input type='button' id='btnExport' value='${ ui.message("isanteplusreports.export") }' onclick="tablesToExcel(['tab_excel'], ['Patients_list'], 'List_of_patients.xls', 'Excel')"/>
</div><br/>
<div id="DivIdToPrint" ng-app="weeklyMonitoringReportPatientList" ng-controller="WeeklyMonitoringPatientListController">
	 ${ ui.message("isanteplusreports.weeklymonitoringreport.indicator.label") } <br/><br/>
	<div id="excel_div">
	<table id="tab_excel">
	    <tr> 
