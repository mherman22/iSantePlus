...
<script type="text/javascript">
    var breadcrumbs = [
        ...
        { label: "${ ui.message("isanteplusreports.report.vitalStatistics") }", link: '${ ui.thisUrl() }' }
    ];
    var jq = jQuery;
    ...
    function generateExcelName() {
        return "VitalStatistics" + formatDate(new Date()) + ".xls";
    }

    function generatePdfName() {
        return "VitalStatistics" + formatDate(new Date()) + ".pdf";
    }
...
<div>
    ...
    <h1>${ ui.message("isanteplusreports.report.vitalStatistics") }</h1>
            ...
            <table id="indicators" style="display:block; width: 100%; padding-top: 11px;">
                ...
                <tbody>
                    <tr>
                     ...
                     <%  manager.vitalStatisticsIndicators.each { indicator -> %>
