...
<div class="reportBox">
    ...
    <ul>
        <% overviews.each {
            if(it.id!="isanteplusreports.septJoursLibelle" && it.id!="isanteplusreports.quatorzeJoursLibelle"
                    && it.id!="isanteplusreports.list_patients_charge_virale_plus_mille_by_result_date"
                    && it.id!="isanteplusreports.list_patients_charge_virale_moins_mille_by_result_date"
                    && it.id!="isanteplusreports.number_charge_virale_by_result_date"){
        %>
        <li>
...
<div class="reportBox">
    ...
    <% if (comorbidity) { %>
    <p>${ ui.message("isanteplusreports.reportsapp.comorbidity") }</p>
    <ul>
        <% comorbidity.each { %>
        <li>
            ${ ui.includeFragment("uicommons", "extension", [ extension: it, contextModel: contextModel ]) }
