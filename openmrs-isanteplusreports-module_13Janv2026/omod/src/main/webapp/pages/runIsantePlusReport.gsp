                    ...
                    <tr ng-repeat="request in completed">
                        ...
                        <td>
                            <span class="download" ng-show="request.status == 'COMPLETED' || request.status == 'SAVED'">
                                  ...
                                  <a href="${ ui.pageLink("isanteplusreports", "viewReportIsantePlusRequest") }?request={{ request.uuid }}" onclick="window.open(this.href, 'windowName', 'width=1000, height=700, left=24, top=24, scrollbars, resizable'); return false;">  
