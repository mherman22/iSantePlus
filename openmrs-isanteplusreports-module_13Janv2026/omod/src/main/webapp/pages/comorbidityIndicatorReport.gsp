...
<script type="text/javascript">
    var breadcrumbs = [
        ...
        {label: "${ ui.message("isanteplusreports.comorbidity.indicator.label") }", link: '${ ui.thisUrl() }'}
    ];
    var jq = jQuery;
    ...
    jq(document).ready(function () {
        ...
        jq('#indicatorsForm').on('submit', function () {
            ...
            // 4️⃣ AJAX POST
            jq.ajax({
                url: "${ ui.pageLink('isanteplusreports','comorbidityIndicatorReport',null) }",
                type: "POST",
        ...
        jq("#btnPdf").on("click", function () {
            ...
            var options = {
                margin: 0.5,
                filename: "rapport_comorbidite.pdf",
        ...
        jq("#btnExcel").on("click", function () {
            ...
            // 💾 Téléchargement
            XLSX.writeFile(wb, "rapport_comorbidite.xlsx");
        });
...
<div>
    <h1>${ui.message("isanteplusreports.comorbidity.indicator.label")}</h1>
    ...
    <div class="running-reports">
        ...
        <form id="indicatorsForm" class="clearfix" method="post">
            ...
            <table id="indicators" style="display: block; width: 100%; padding-top: 11px;">
                <thead>
                <tr>
                    <th style="width:100%">${ui.message("isanteplusreports.comorbidity.indicator.label")}</th>
                ...
                <tr>
                    <th class="indicatorsHeader" colspan="2">
                        ${ui.message("isanteplusreports.comorbidity.indicator.HTA.type.label")} & Diabète
                    </th>
                </tr>
...
<div id="" style="width: 70%; margin-left: auto; margin-right: auto">
    ...
    <div id="reportContent" style="width: 100%; margin-left: auto; margin-right: auto">
        <% comorbidityReportResults.each { indicator -> %>
        <table class="centered-table">
            ...
            <tr>
                <td>
                    <a href="${ui.pageLink('isanteplusreports', 'comorbidityIndicatorReportPatientList',
