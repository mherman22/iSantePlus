...
<script type="text/javascript">
    var breadcrumbs = [
        ...
        { label: "${ ui.message("isanteplusreports.fingerprint.indicator.label") }", link: '${ ui.thisUrl() }' }
    ];
    var jq = jQuery;
...
<div>
    ...
    <h1>${ ui.message("isanteplusreports.fingerprint.indicator.label") }</h1>
            ...
            <table id="indicators" style="display:block; width: 100%; padding-top: 11px;">
                ...
                <tbody>
                    <tr>
                     ...
                     <%  manager.fingerPrintIndicators.each { indicator -> %>
