...
public class DdpByPeriodReportListPageController {
	
	
	public void get(@SpringBean DdpReportManager reportManager, @SpringBean CoreAppsProperties coreAppsProperties,
		...
		DataSet dataSet = Context.getService(IsantePlusReportsService.class).patientListDdpByPeriod(
