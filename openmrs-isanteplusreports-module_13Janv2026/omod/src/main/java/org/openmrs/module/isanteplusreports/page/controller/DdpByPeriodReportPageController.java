...
import org.openmrs.module.isanteplusreports.definitions.DdpReportManager;
...
public class DdpByPeriodReportPageController {
private final Log log = LogFactory.getLog(getClass());
	
	public void get(@SpringBean DdpReportManager reportManager,
		...
		model.addAttribute("ddpRows", null);
	...
	public void post(@SpringBean DdpReportManager reportManager,
		...
		model.addAttribute("reportManager", reportManager);
		model.addAttribute("ddpRows", reportData.getDataSets().get(DdpReportManager.DATA_SET_NAME));
