...
(SELECT ps.patient_id, MAX(DATE(ps.date_started_status)) AS date_status
 ...
 HAVING COUNT(en.encounter_id) = 3)D, isanteplus.patient_laboratory labo
 ...
 AND D.patient_id = labo.patient_id
 ...
 AND DATE(labo.visit_date) > DATE(D.date_visite)
 AND labo.test_id = 856 AND labo.test_result > 1000
