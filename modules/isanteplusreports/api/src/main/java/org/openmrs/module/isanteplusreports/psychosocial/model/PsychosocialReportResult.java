package org.openmrs.module.isanteplusreports.psychosocial.model;

import java.util.List;
import java.util.Objects;

public class PsychosocialReportResult {
    ...
    public PsychosocialReportResult() {
    }

    public PsychosocialReportResult(String indicatorLabel, List<PatientSummary> patientListNume, List<PatientSummary> patientListDeno) {
    ...
    public boolean equals(Object o) {
        ...
        PsychosocialReportResult that = (PsychosocialReportResult) o;
