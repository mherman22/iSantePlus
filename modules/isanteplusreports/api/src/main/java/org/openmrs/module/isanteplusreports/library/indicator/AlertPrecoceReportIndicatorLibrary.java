...
import org.openmrs.module.isanteplusreports.library.cohort.AlertPrecoceReportCohortLibrary;
...
public class AlertPrecoceReportIndicatorLibrary {
    ...
    public static CohortIndicator cohortIndicatorFromSqlResource(String sql, String name, List<Parameter> parameters) {
        return EmrReportingUtils.cohortIndicator(name, parameters,
                Mapped.mapStraightThrough(AlertPrecoceReportCohortLibrary.cohortFromSqlResource(sql, name, parameters)));
    }
