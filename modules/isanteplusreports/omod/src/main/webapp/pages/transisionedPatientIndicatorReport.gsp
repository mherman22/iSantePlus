...
<script type="text/javascript">
    var breadcrumbs = [
        ...
        { label: "${ ui.message("isanteplusreports.report.transitionedPatient") }", link: '${ ui.thisUrl() }' }
    ];
    var jq = jQuery;
    ...
    function generateExcelName() {
        return "PatientsTransitiones" + formatDate(new Date()) + ".xls";
    }

    function generatePdfName() {
        return "PatientsTransitiones" + formatDate(new Date()) + ".pdf";
    }
...
<div>
    ...
    <h1>${ ui.message("isanteplusreports.report.transitionedPatient") }</h1>
            ...
            <table id="indicators" style="display:block; width: 100%; padding-top: 11px;">
                ...
                <tbody>
                    <tr>
                     ...
                     <%  manager.transisionedPatientIndicators.each { indicator -> %>
                        ${ ui.includeFragment("isanteplusreports", "selectedIndicator", [indicator: indicator]) }
                    <% } %>
                </tbody>
            </table>
        </form>
