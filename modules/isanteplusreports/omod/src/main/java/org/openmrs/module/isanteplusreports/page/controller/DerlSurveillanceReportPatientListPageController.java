...
@Transactional
public class DerlSurveillanceReportPatientListPageController {
    ...
    public String get(@SpringBean DerlSurveillanceReportDataset derlSurveillanceReportDataset,
        ...
        List<PatientSummary> patientSummaryList = derlSurveillanceReportDataset.getAllPatientSummaries(ids);
