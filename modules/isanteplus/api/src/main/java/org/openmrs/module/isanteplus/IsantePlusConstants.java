...
public class IsantePlusConstants {
    ...
    public static final Integer RELATIONSHIPS_CONCEPT_ID = 1560;
    public static final Integer EMERGENCY_CONTACT_CONCEPT_ID = 165210;
    public static final String EMERGENCY_CONTACT_NAME_CONCEPT_UUID = "163258AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
    public static final String EMERGENCY_CONTACT_RELATION_CONCEPT_UUID = "164352AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
    public static final String EMERGENCY_CONTACT_PHONE_CONCEPT_UUID = "159635AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";


    public static final Integer RELATIONSHIPS_FULLNAME_CONCEPT_ID = 1560;
    public static final Integer RELATIONSHIPS_PHONENUMBER_CONCEPT_ID = 1560;
}
