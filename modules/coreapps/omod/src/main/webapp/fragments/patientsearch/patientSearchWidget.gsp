...
<form method="get" id="patient-search-form" onsubmit="return false" style="background: #fff; width: 96.1%; margin: auto; padding: 20px">
...
<div id="patient-search-results"  style="width: 96%; background: #fff; margin: auto; padding: 20px"></div>
